...
RCT_EXPORT_VIEW_PROPERTY(onLoadingCommit, RCTDirectEventBlock)
...
RCT_EXPORT_VIEW_PROPERTY(onRetractBarsRecommendation, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onPress, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onScroll, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onScrollEndDrag, RCTDirectEventBlock)
RCT_EXPORT_VIEW_PROPERTY(onScrollViewWillBeginDecelerating, RCTDirectEventBlock)
